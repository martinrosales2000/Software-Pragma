...
public class frmVenta extends javax.swing.JFrame {
    ...
    GetSetVenta aceV = new GetSetVenta();
    ...
    private void cargarTabla() {
        ...
        try {
            ...
            String sql = "SELECT id_venta, subTotal, venta.id_usuario, usuario.nombre_usuario FROM venta JOIN usuario ON venta.id_usuario = usuario.id_usuario ORDER BY id_venta ASC;";
            rs = st.executeQuery(sql);
            while (rs.next()) {
                DataInv[0] = Integer.toString(rs.getInt("id_venta"));
                DataInv[1] = Double.toString(rs.getDouble("subTotal"));
                DataInv[2] = Integer.toString(rs.getInt("id_usuario"));
                DataInv[3] = rs.getString("nombre_usuario");
    ...
    public void InterfazDetalle(){
        frmDetalleVenta edDat = new frmDetalleVenta();
        edDat.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jvTabla1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id Venta", "Sub-total", "Id_usuario", "nombre_usuario"
            }
        ));
        ...
        btnDetalle.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        btnDetalle.setText("Detalle de venta");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnDetalle, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//            JOptionPane.showMessageDialog(null, idI+"--"+Ubic+"--"+idU);
    ...
    private void btnDetalleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalleActionPerformed
        if (jvTabla1.getSelectedRow() == -1) {
            ...
            String idV = (String) miTabla.getValueAt(jvTabla1.getSelectedRow(), 0);
            String subT = (String) miTabla.getValueAt(jvTabla1.getSelectedRow(), 1);
            String idU= (String) miTabla.getValueAt(jvTabla1.getSelectedRow(), 2);
            String Usu= (String) miTabla.getValueAt(jvTabla1.getSelectedRow(), 3);
            aceV.setIdVenta(Integer.parseInt(idV));;
            aceV.setSubTotal(Double.parseDouble(subT));
            aceV.setIdUsuario(Integer.parseInt(idU));
            aceV.setNombre_usuario(Usu);
            InterfazDetalle();
            this.dispose();
        }
