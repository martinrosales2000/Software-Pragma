 ...
 * @author Augus
 */
public class frmLoteProducto extends javax.swing.JFrame {
    ...
    private void cargarTabla() {
        ...
        try {
            ...
            String sql = "SELECT " + "\"loteProducto\"" + "." + "\"id_loteProducto\"" + ", nombre_producto, fecha_caducidad, stock "
                    + "FROM " + "\"loteProducto\"" + " ORDER BY" + "\"loteProducto\"" + "." + "\"id_loteProducto\"" + "ASC;";
            rs = st.executeQuery(sql);
            while (rs.next()) {
                DataInv[0] = Integer.toString(rs.getInt("id_loteProducto"));
                DataInv[1] = rs.getString("nombre_producto");
                DataInv[2] = rs.getDate("fecha_caducidad") + "";
                DataInv[3] = Integer.toString(rs.getInt("stock"));
    ...
    public void IntertfazIngresarDatos() {
        frmIngresarLP ingDat = new frmIngresarLP();
        ingDat.setVisible(true);
    }

    public void InterfazEditar() {
        frmEditarLP edDat = new frmEditarLP();
        edDat.setVisible(true);
    }

    public void InterfazEliminar() {
        frmEliminarLP edDat = new frmEliminarLP();
        edDat.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Lote producto");
        ...
        jvTabla1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id de Lote", "Producto", "Fecha de caducidad", "Existencias"
            }
        ));
...
//            oInv.eliminar(Integer.parseInt(id));
            String idLP = (String) miTabla.getValueAt(jvTabla1.getSelectedRow(), 0);
            String NomP = (String) miTabla.getValueAt(jvTabla1.getSelectedRow(), 1);
            String FecC = (String) miTabla.getValueAt(jvTabla1.getSelectedRow(), 2);
            String Stock = (String) miTabla.getValueAt(jvTabla1.getSelectedRow(), 3);
            alp.setIdLoteProducto(Integer.parseInt(idLP));
            alp.setNombreProducto(NomP);
            alp.setFechaCaducidad(FecC);
            alp.setStock(Integer.parseInt(Stock));
            InterfazEliminar();
            this.dispose();
        }
